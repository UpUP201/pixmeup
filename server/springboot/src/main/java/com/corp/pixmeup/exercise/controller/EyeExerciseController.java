package com.corp.pixmeup.exercise.controller;
...
import com.corp.pixmeup.exercise.service.EyeExerciseRecordService;
import com.corp.pixmeup.exercise.service.EyeExerciseService;
...
public class EyeExerciseController {
	...
	@ApiResponses(value = {
		...
		@ApiResponse(responseCode = "404", description = "요청한 리소스를 찾을 수 없습니다.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = com.corp.pixmeup.global.error.dto.ErrorResponse.class)))
	})
	@GetMapping("/{id}/start")
